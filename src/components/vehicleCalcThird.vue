...
<div>
    ...
    <div>
        <v-app-bar color="light">
            ...
            <h3 style="margin-right : 10%">اضافه اشاره <i class='bx bx-car'></i> </h3>
    ...
    <div style="display : flex ;  justify-content:center ; margin-right:20px; margin-top:20px">
        <div style="display : flex ; justify-content : center;align-items:center ; margin-right:100px ;">
            ...
            <label style="margin-right: 200px;margin-top:-15px">الاشاره </label>
...
export default {
    ...
    created() {
        this.$store.dispatch("addCalcVehicle_3");
        this.populateUnitTable()
    },

    computed: {
        getCatData() {
            return this.$store.getters.calc3Getter
        },
        getUnitData() {
        ...
        // },
        getCalc1Data() {
            return this.$store.getters.call3Getter
        }
    },
    ...
    methods: {
        ...
        populateUnitTable() {
            ...
            this.$store.dispatch("calcVehicleTable3", {
        ...
        createData() {
            if (this.selectedCat && this.date && this.info.id && this.countV) {
                this.$store.dispatch("insertCalcVehicleTable3", {

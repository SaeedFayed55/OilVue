        ...
        <template #header>
            ...
            <div class="box" style=" margin-right : -300px; margin-top:20px">
                ...
                <select style="border:1px solid gray; border-radius : 2px solid red ; " v-model="selectedData" @change="populateTable()">
                    ...
                    <option value="" selected disabled hidden><i class='bx bx-home'></i> من فضلك اختار نوع م ع </option>

                    <option v-for="(i, key) in getvehiclesTypesData_4" :key="key" :value="i.VEHICLE_TYPE_ID">
                        {{ i.VEHICLE_TYPE_NAME }}
...
export default {
    ...
    created() {
        this.$store.dispatch("getvehiclesTypesData_4")
    },

    computed: {
        getvehiclesTypesData_4() {
            return this.$store.getters.vehiclesTypesGetter_4
        },
        getvehiclesData() {

...
<div>
    ...
    <div>
        <v-app-bar color="light">
            ...
            <h3 style="margin-right : 10%">اضافه مدرعه <i class='bx bx-car'></i> </h3>
    ...
    <div style="display : flex ;  justify-content:center ; margin-right:20px; margin-top:20px">
        <div style="display : flex ; justify-content : center;align-items:center ; margin-right:100px ;">
            ...
            <label style="margin-right: 200px;margin-top:-15px">عدد المدرعات</label>
...
export default {
    ...
    created() {
        this.$store.dispatch("addCalcVehicle_1");
        this.populateUnitTable()
    },

    computed: {
        getCatData() {
            return this.$store.getters.GetterTable1
        },
        getUnitData() {
